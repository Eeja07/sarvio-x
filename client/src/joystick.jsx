function VirtualJoystick({ joystickPosition, setJoystickPosition }) {
  ...
  return (
    <div className="relative w-64 h-64 bg-deep-teal rounded-full border-2 border-slate-600">
      <div 
        className="absolute inset-2 bg-dark-cyan rounded-full cursor-pointer"
        onMouseMove={handleJoystickMove}
      >
        <div 
          className="absolute w-12 h-12 bg-light-blue rounded-full transform -translate-x-1/2 -translate-y-1/2"
          style={{
